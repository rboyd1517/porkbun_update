...
resp = urllib.request.urlopen(f'https://api.porkbun.com/api/json/v3/dns/retrieve/{domain}/{id}',
...
if old_ip != ip:
    ...
    resp = urllib.request.urlopen(f'https://api.porkbun.com/api/json/v3/dns/edit/{domain}/{id}',
